...
public class Quiz6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (answer1RadioButton.isChecked() || answer2RadioButton.isChecked() || answer3RadioButton.isChecked() || answer4RadioButton.isChecked()) {
                    ...
                    if (difficulty.equals("Easy")) {
                        if (Jawaban_User.equalsIgnoreCase("87")) {
                    ...
                    if (difficulty.equals("Hard")) {
                        if (Jawaban_User.equalsIgnoreCase("40")) {
                            if (countDownTimer != null) {
                                countDownTimer.cancel();
                            }
                            if (nilai < 6) {
        ...
        selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Jawaban_User = Pilihan_User.getText().toString();
                if(difficulty.equals("Easy")) {
                    if (Jawaban_User.equalsIgnoreCase("87") && nilai >= 6) {
                ...
                if(difficulty.equals("Medium")) {
                    if (Jawaban_User.equalsIgnoreCase("14") && nilai >= 6) {
                        Intent intent = new Intent(Quiz6.this, Quiz7.class);
                        intent.putExtra("nilai", nilai);
                        intent.putExtra("difficulty", difficulty);
                        startActivity(intent);
                ...
                if(difficulty.equals("Hard")) {
                    if (Jawaban_User.equalsIgnoreCase("40") && nilai >= 6) {
                        Intent intent = new Intent(Quiz6.this, Quiz7.class);
                        intent.putExtra("nilai", nilai);
                        intent.putExtra("difficulty", difficulty);
                        startActivity(intent);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Quiz6.this, Game.class);
