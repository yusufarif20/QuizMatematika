...
public class Quiz9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (difficulty.equals("Easy")) {
            ...
            Question.setText("((7 x 5)+24)-(30/6)");
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (answer1RadioButton.isChecked() || answer2RadioButton.isChecked() || answer3RadioButton.isChecked() || answer4RadioButton.isChecked()) {
                    ...
                    if (difficulty.equals("Easy")) {
                        if (Jawaban_User.equalsIgnoreCase("187")) {
                    ...
                    if (difficulty.equals("Medium")) {
                        if (Jawaban_User.equalsIgnoreCase("48")) {
                            if (countDownTimer != null) {
                                countDownTimer.cancel();
                            }
                            if (nilai < 9) {
                    ...
                    if (difficulty.equals("Hard")) {
                        if (Jawaban_User.equalsIgnoreCase("54")) {
                            if (countDownTimer != null) {
                                countDownTimer.cancel();
                            }
                            if (nilai < 9) {
        ...
        selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Jawaban_User = Pilihan_User.getText().toString();
                if(difficulty.equals("Easy")) {
                    if (Jawaban_User.equalsIgnoreCase("187") && nilai >= 9) {
                        Intent intent = new Intent(Quiz9.this, FinalQuiz.class);
                ...
                if(difficulty.equals("Medium")) {
                    if (Jawaban_User.equalsIgnoreCase("48") && nilai >= 3) {
                        Intent intent = new Intent(Quiz9.this, FinalQuiz.class);
                        intent.putExtra("nilai", nilai);
                        intent.putExtra("difficulty", difficulty);
                        startActivity(intent);
                ...
                if(difficulty.equals("Hard")) {
                    if (Jawaban_User.equalsIgnoreCase("54") && nilai >= 3) {
                        Intent intent = new Intent(Quiz9.this, FinalQuiz.class);
                        intent.putExtra("nilai", nilai);
                        intent.putExtra("difficulty", difficulty);
                        startActivity(intent);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Quiz9.this, Game.class);
