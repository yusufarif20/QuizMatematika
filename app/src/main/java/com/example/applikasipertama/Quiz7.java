...
public class Quiz7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (answer1RadioButton.isChecked() || answer2RadioButton.isChecked() || answer3RadioButton.isChecked() || answer4RadioButton.isChecked()) {
                    ...
                    if (difficulty.equals("Easy")) {
                        if (Jawaban_User.equalsIgnoreCase("12")) {
                    ...
                    if (difficulty.equals("Medium")) {
                        if (Jawaban_User.equalsIgnoreCase("42")) {
                            if (countDownTimer != null) {
                                countDownTimer.cancel();
                            }
                            if (nilai < 7) {
                    ...
                    if (difficulty.equals("Hard")) {
                        if (Jawaban_User.equalsIgnoreCase("50")) {
                            if (countDownTimer != null) {
                                countDownTimer.cancel();
                            }
                            if (nilai < 7) {
        ...
        selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Jawaban_User = Pilihan_User.getText().toString();
                if(difficulty.equals("Easy")) {
                    if (Jawaban_User.equalsIgnoreCase("12") && nilai >= 7) {
                ...
                if(difficulty.equals("Medium")) {
                    if (Jawaban_User.equalsIgnoreCase("42") && nilai >= 7) {
                        Intent intent = new Intent(Quiz7.this, Quiz8.class);
                        intent.putExtra("nilai", nilai);
                        intent.putExtra("difficulty", difficulty);
                        startActivity(intent);
                ...
                if(difficulty.equals("Hard")) {
                    if (Jawaban_User.equalsIgnoreCase("50") && nilai >= 7) {
                        Intent intent = new Intent(Quiz7.this, Quiz8.class);
                        intent.putExtra("nilai", nilai);
                        intent.putExtra("difficulty", difficulty);
                        startActivity(intent);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Quiz7.this, Game.class);
