...
public class Quiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (answer1RadioButton.isChecked() || answer2RadioButton.isChecked() || answer3RadioButton.isChecked() || answer4RadioButton.isChecked()) {
                    ...
                    if (difficulty.equals("Easy")) {
                        if (Jawaban_User.equalsIgnoreCase("24")) {
                    ...
                    if (difficulty.equals("Medium")) {
                        if (Jawaban_User.equalsIgnoreCase("9")) {
                            if (countDownTimer != null) {
                                countDownTimer.cancel();
                            }
                            if (nilai < 4) {
                    ...
                    if (difficulty.equals("Hard")) {
                        if (Jawaban_User.equalsIgnoreCase("180")) {
                            if (countDownTimer != null) {
                                countDownTimer.cancel();
                            }
                            if (nilai < 4) {
        ...
        selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Jawaban_User = Pilihan_User.getText().toString();
                if(difficulty.equals("Easy")) {
                    if (Jawaban_User.equalsIgnoreCase("24") && nilai >= 4) {
                ...
                if(difficulty.equals("Medium")) {
                    if (Jawaban_User.equalsIgnoreCase("9") && nilai >= 4) {
                        Intent intent = new Intent(Quiz4.this, Quiz5.class);
                        intent.putExtra("nilai", nilai);
                        intent.putExtra("difficulty", difficulty);
                        startActivity(intent);
                ...
                if(difficulty.equals("Hard")) {
                    if (Jawaban_User.equalsIgnoreCase("180") && nilai >= 4) {
                        Intent intent = new Intent(Quiz4.this, Quiz5.class);
                        intent.putExtra("nilai", nilai);
                        intent.putExtra("difficulty", difficulty);
                        startActivity(intent);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Quiz4.this, Game.class);
