...
public class Quiz8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (answer1RadioButton.isChecked() || answer2RadioButton.isChecked() || answer3RadioButton.isChecked() || answer4RadioButton.isChecked()) {
                    ...
                    if (difficulty.equals("Easy")) {
                        if (Jawaban_User.equalsIgnoreCase("10")) {
                    ...
                    if (difficulty.equals("Hard")) {
                        if (Jawaban_User.equalsIgnoreCase("60")) {
                            if (countDownTimer != null) {
                                countDownTimer.cancel();
                            }
                            if (nilai < 8) {
        ...
        selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Jawaban_User = Pilihan_User.getText().toString();
                if(difficulty.equals("Easy")) {
                    if (Jawaban_User.equalsIgnoreCase("10") && nilai >= 8) {
                ...
                if(difficulty.equals("Medium")) {
                    if (Jawaban_User.equalsIgnoreCase("42") && nilai >= 8) {
                        Intent intent = new Intent(Quiz8.this, Quiz9.class);
                        intent.putExtra("nilai", nilai);
                        intent.putExtra("difficulty", difficulty);
                        startActivity(intent);
                ...
                if(difficulty.equals("Hard")) {
                    if (Jawaban_User.equalsIgnoreCase("60") && nilai >= 8) {
                        Intent intent = new Intent(Quiz8.this, Quiz9.class);
                        intent.putExtra("nilai", nilai);
                        intent.putExtra("difficulty", difficulty);
                        startActivity(intent);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Quiz8.this, Game.class);
